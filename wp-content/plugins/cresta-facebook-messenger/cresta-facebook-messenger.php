<?php
/**
 * Plugin Name: Cresta Facebook Messenger
 * Plugin URI: https://crestaproject.com/downloads/cresta-facebook-messenger/
 * Description: <strong>*** <a href="https://crestaproject.com/downloads/cresta-facebook-messenger/" target="_blank">Get Cresta Facebook Messenger PRO</a> ***</strong> Allow your users and customers to contact you via Facebook Messenger with a single click.
 * Version: 1.1.1
...
define( 'CRESTA_FACEBOOK_MESSENGER_PLUGIN_VERSION', '1.1.1' );
			...
			"use strict";
				$(document).ready(function() {
					...
					(function(d, s, id) {
					  ...
					  js.src = "https://connect.facebook.net/'.esc_attr(trim($facebook_language)).'/sdk.js#xfbml=1&version=v3.0&autoLogAppEvents=1";
...
function add_cresta_facebook_messenger_box() {
	...
	if ($facebook_show_floating_box == 1 && cresta_facebook_messenger_show_floating()) {
		...
		<script>(function(d, s, id) {
		  ...
		  if (d.getElementById(id)) return;
		  js = d.createElement(s); js.id = id;
		  js.src = "https://connect.facebook.net/<?php echo esc_attr(trim($facebook_language)); ?>/sdk.js#xfbml=1&version=v3.0&autoLogAppEvents=1";
		  fjs.parentNode.insertBefore(js, fjs);
		}(document, 'script', 'facebook-jssdk'));
		(function($) {
		"use strict";
...
function cresta_facebook_messenger_option() {
	...
	<div class="wrap">
		...
		<h2><?php esc_html_e('Cresta Facebook Messenger FREE', 'cresta-facebook-messenger'); ?></h2>
		<div id="poststuff">
				...
				<div id="postbox-container-1" class="postbox-container">
					<div class="meta-box-sortables">
						<div class="postbox">
							...
							<div class="inside">
								<?php echo wp_kses_post( 'Do not forget to rate <strong>Cresta Facebook Messenger</strong> on WordPress Pugins Directory.<br/>We really appreciate it ;)', 'cresta-facebook-messenger' ); ?>
								<br/>
								<img src="<?php echo esc_url( plugins_url( '/images/5-stars.png' , __FILE__ )); ?>">
								<br/>
								<a class="crestaButton" href="https://wordpress.org/support/plugin/cresta-facebook-messenger/reviews/#new-post"title="<?php esc_attr_e( 'Rate Cresta Facebook Messenger on Wordpress Plugins Directory', 'cresta-facebook-messenger' ); ?>" class="btn btn-primary" target="_blank"><?php esc_html_e( 'Rate Cresta Facebook Messenger', 'cresta-facebook-messenger' ); ?></a>
							</div> <!-- .inside -->
						</div> <!-- .postbox -->
						...
						<div class="postbox" style="border: 4px solid #1182fc;">
							...
							<div class="inside">
								<a href="https://crestaproject.com/downloads/cresta-facebook-messenger/" target="_blank" alt="Get Cresta Facebook Messenger PRO"><img src="<?php echo esc_url(plugins_url( '/images/banner-cresta-facebook-messenger-pro.png' , __FILE__ )); ?>"></a><br/>
								<?php echo wp_kses_post( 'Get <strong>Cresta Facebook Messenger PRO</strong> for only', 'cresta-facebook-messenger' ); ?> <strong>9,99&euro;</strong><br/>
								<ul>
